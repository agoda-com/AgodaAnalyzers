...
namespace Agoda.Analyzers.AgodaCustom
{
    ...
    public class AG0003HttpContextCannotBePassedAsMethodArgument : DiagnosticAnalyzer
    {
        ...
        private static readonly LocalizableString Description = DescriptionContentLoader.GetAnalyzerDescription(nameof(AG0003HttpContextCannotBePassedAsMethodArgument));
