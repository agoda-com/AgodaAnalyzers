...
namespace Agoda.Analyzers.AgodaCustom {
    ...
    public class CustomRulesResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Playwright screenshot/snapshot assertions must be preceded by an explicit wait.
        /// </summary>
        public static string AG0053Title {
            get {
                return ResourceManager.GetString("AG0053Title", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Add an explicit wait (ToBeVisibleAsync, WaitForAsync, or WaitForSelectorAsync) before taking a screenshot or snapshot to avoid flaky visual tests.
        /// </summary>
        public static string AG0053MessageFormat {
            get {
                return ResourceManager.GetString("AG0053MessageFormat", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Taking screenshots or snapshot assertions without first waiting for elements to be visible and stable causes flaky visual tests.
        /// </summary>
        public static string AG0053Description {
            get {
                return ResourceManager.GetString("AG0053Description", resourceCulture);
            }
        }
